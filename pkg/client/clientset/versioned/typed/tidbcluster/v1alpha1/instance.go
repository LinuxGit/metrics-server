...
import (
	...
	scheme "github.com/kubernetes-incubator/metrics-server/pkg/client/clientset/versioned/scheme"
...
func newInstances(c *TepV1alpha1Client, namespace string) *instances {
	return &instances{
		client: c.RESTClient(),
		ns:     namespace,
	}
